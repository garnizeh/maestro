...
func (v *VFS) WriteMeta(dir string, meta VFSMeta) error { return v.writeMeta(dir, meta) }

func (v *VFS) CopyDir(src, dst string) error  { return v.copyDir(src, dst) }
func (v *VFS) CopyFile(src, dst string) error { return v.copyFile(src, dst) }
